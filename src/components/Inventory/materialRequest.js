          ...
          <GridItem>
            ...
            >
              <InputGroup maxW="350px">
                ...
                <Input
                  placeholder="Search by item name, ID, or requester..."
                  value={searchQuery}
              ...
              <Menu>
                ...
                <MenuList maxH="300px" overflowY="auto">
                  <MenuItem onClick={() => setWarehouseFilter("")}>
                    <Flex justify="space-between" width="100%">
                      <Text>All Warehouses</Text>
                      {warehouseFilter === "" && <CheckIcon color="#550000" />}
                    </Flex>
                  </MenuItem>
                  <Divider />
                  {warehouses.map((warehouse) => (
                    <MenuItem
                      key={warehouse._id}
                      onClick={() => setWarehouseFilter(warehouse._id)}
                    >
                      <Flex justify="space-between" width="100%">
                        <Text>{warehouse.name}</Text>
                        {warehouseFilter === warehouse._id && (
                          <CheckIcon color="#550000" />
                        )}
                      </Flex>
                    </MenuItem>
                  ))}

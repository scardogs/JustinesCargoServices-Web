...
const Company = dynamic(() => import("../../pages/Company/companyPage"), {
  ssr: false,
});
const WaybillActivation = dynamic(
  () => import("../WaybillOffiicer/WaybillManagement/WOwaybillActivation"),
  {
    ssr: false,
  }
);
const WaybillManagement = dynamic(
  () => import("../WaybillOffiicer/WaybillManagement/waybilltable"),
  {
    ssr: false,
  }
);
...
const roleAccess = {
  ...
  "Waybill Officer": ["Dashboard", "Waybill", "Customer"],
...
const linkItems = [
  { name: "Dashboard", icon: MdOutlineDashboard, path: "/dashboard" },
  {
    ...
    icon: FaUserTie,
    subMenu: [
      { name: "Company", icon: GoHorizontalRule, path: "/customer/company" },
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        ...
        // If there's another type of error, try to use stored user data
        try {
          const storedUser = localStorage.getItem("user");
          if (storedUser) {
...
const SidebarWithHeader = () => {
  ...
  }, []); // No dependencies needed if setCurrentComponent is stable
  ...
  const renderComponent = () => {
    switch (currentComponent) {
      ...
      case "/inventory/purchase":
        return <Purchase />;
      case "/inventory/material-request":
        return <MaterialRequest />;
      case "/Reports/EmpReports":
        return <EmpReports />;
      case "/Reports/TruckReports":
        return <TrucksReports />;
      case "/Reports/BillingReports":
        return <BillingReports />;
      case "/Reports/RenewalReports":
        return <RenewalReportsPage />;
      case "/Reports/InventoryReports":
        return <InventoryReportsPage />;
      case "/Reports/PayrollReport":
  ...
  return (
    ...
    >
      <SidebarContent
        ...
        workLevel={user?.workLevel || "Admin"}
      />

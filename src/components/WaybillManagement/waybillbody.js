...
import EntityAbbreviationSummary, {
  ...
  fetchSubDetails,
} from "./EntityAbbreviationSummary";
// import WaybillHeader from "../WaybillOffiicer/WaybillManagement/WOWaybillHeader";
import WaybillHeader from "./WaybillHeader";
// import ShipperInformation from "../WaybillOffiicer/WaybillManagement/WOShipperInformation";
import ShipperInformation from "./ShipperInformation";
// import ConsigneeInformation from "../WaybillOffiicer/WaybillManagement/WOConsigneeInformation";
import ConsigneeInformation from "./ConsigneeInformation";
import ConsigneeDrawer from "./ConsigneeDrawer";
import EditDrawer from "./EditDrawer";
import FixRateConsigneeDrawer from "./FixRateConsigneeDrawer";
...
const WaybillBody = ({
  ...
  // Add this utility function at the top-level of the file if not present
  ...
  // Auto-close drawer if CBM is full
  useEffect(() => {

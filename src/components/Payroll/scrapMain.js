...
import ScrapPakyawComponent from './Scrap/scrapPakyaw.js'; 
import DailyPayrollComponent from './Scrap/scrapDaily'; 
...
// Helper: Get first and last day of month (YYYY-MM-DD)
    ...
    <MotionBox>
      ...
      >
        <Heading size="2xl" fontWeight="bold">
          Justine's Scrap - Payroll Management
        </Heading>
      ...
      <Tabs
        ...
        mb={6}
      >
        <TabList bg="white" borderBottom="2px" borderColor={secondaryColor} align="start">
        ...
        <TabPanels mt={4}>
           ...
           {/* Daily Payroll Panel */}
           <TabPanel p={0}>
            <DailyPayrollComponent />
          </TabPanel>

          
          {/* Pakyaw Payroll Panel */}
          <TabPanel p={0}>
            <ScrapPakyawComponent />
          </TabPanel>
...
export default ScrapMainPayroll;

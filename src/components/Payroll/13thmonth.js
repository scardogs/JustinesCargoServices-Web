...
const ThirteenthMonth = () => {
  ...
  const [modalOpenEmpId, setModalOpenEmpId] = useState(null);
                          ...
                          >
                            ...
                            <Td py={2} px={4} textAlign="center">
                              {payoutOption === 'Semi-Annually' ? (
                                <Button size="xs" colorScheme="blue" onClick={() => setModalOpenEmpId(empId)}>
                                  Edit
                                </Button>
                              ) : (
                              ...
                              <Modal isOpen={modalOpenEmpId === empId} onClose={() => setModalOpenEmpId(null)} isCentered>
                                <ModalOverlay />
                                <ModalContent borderRadius="lg" boxShadow="0 4px 24px rgba(26,54,93,0.18)">
                                  <ModalHeader bg="#800020" color="white" borderTopRadius="lg" fontSize="lg" fontWeight="bold" letterSpacing="0.5px">
                                    Edit Payout Details
                                  </ModalHeader>
                                  <ModalCloseButton color="white" _focus={{ boxShadow: '0 0 0 2px #1a365d' }} />
                                  <ModalBody bg="white" borderBottomRadius="lg">
                                    <VStack spacing={4} align="stretch">
                                      <FormControl>
                                        <FormLabel fontWeight="semibold" fontSize="sm" color="#800020">1st: Amount</FormLabel>
                                        <InputGroup size="md">
                                          <InputLeftAddon children="₱" bg="#1a365d" color="white" />
                                          <Input
                                            type="number"
                                            value={record.firstAmount || ''}
                                            onChange={e => handlePayoutRecordChange(empId, 'firstAmount', e.target.value)}
                                            placeholder="Amount"
                                            isInvalid={firstAmountInvalid}
                                            fontSize="md"
                                            focusBorderColor="#800020"
                                            _focus={{ borderColor: '#800020', boxShadow: '0 0 0 1.5px #800020' }}
                                          />
                                        </InputGroup>
                                      </FormControl>
                                      <FormControl>
                                        <FormLabel fontWeight="semibold" fontSize="sm" color="#1a365d">Date</FormLabel>
                                        <InputGroup size="md">
                                          <InputLeftAddon children={<CalendarIcon />} bg="#1a365d" color="white" />
                                          <Input
                                            type="date"
                                            value={record.firstDate || ''}
                                            onChange={e => handlePayoutRecordChange(empId, 'firstDate', e.target.value)}
                                            fontSize="md"
                                            focusBorderColor="#800020"
                                            _focus={{ borderColor: '#800020', boxShadow: '0 0 0 1.5px #800020' }}
                                          />
                                      ...
                                      {firstAmountInvalid && (
                                        <Text color="red.500" fontSize="sm" mt={2}>First payout cannot exceed total 13th month pay ({formatCurrency(originalThirteenthMonthTotal)}).</Text>
                                      )}
                                    </VStack>
                                  </ModalBody>
                                  <ModalFooter bg="gray.50" borderBottomRadius="lg">
                                    <Button
                                      ...
                                      _hover={{ bg: '#a8323e' }}
                                      mr={3}
                                      isLoading={saving[empId]}
                                      onClick={() => { handleSavePayout(empId, employee); setModalOpenEmpId(null); }}
                                      isDisabled={!record.firstAmount || !record.firstDate || firstAmountInvalid}
                                      borderRadius="md"
                                      fontWeight="semibold"
                                      px={6}
                                    ...
                                    <Button
                                      variant="ghost"
                                      color="#1a365d"
                                      _hover={{ bg: '#e3e8f0', color: '#800020' }}
                                      onClick={() => setModalOpenEmpId(null)}
                                      borderRadius="md"
                                      fontWeight="semibold"
                                    >
                                      Cancel

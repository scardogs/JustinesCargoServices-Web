...
const Items = dynamic(() => import("../InventoryOfficer/Inventory/IOitem"), {
  ssr: false,
});
const Category = dynamic(
  () => import("../InventoryOfficer/Inventory/IOcategory"),
  {
    ssr: false,
  }
);
const Warehouse = dynamic(
  () => import("../InventoryOfficer/Inventory/IOwarehouse"),
  {
    ssr: false,
  }
);
const Stocks = dynamic(
  () => import("../InventoryOfficer/Inventory/IOstockMovement"),
  {
    ssr: false,
  }
);
const Purchase = dynamic(
  () => import("../InventoryOfficer/Inventory/IOpurchaseComp"),
  {
    ssr: false,
  }
);
const MaterialRequest = dynamic(
  () => import("../InventoryOfficer/Inventory/IOmaterialRequestComp"),
  {
    ssr: false,
  }
);
...
const linkItems = [
  ...
  { name: "Employee Records", icon: FaUserTie, path: "/employees" },
  {
    ...
    subMenu: [
      { name: "Items", icon: FaListAlt, path: "/inventory-officer/items" },
      {
        name: "Category",
        icon: FaBorderAll,
        path: "/inventory-officer/category",
      },
      {
        name: "Warehouse",
        icon: FaWarehouse,
        path: "/inventory-officer/warehouse",
      },
      {
        name: "Stock Logs",
        icon: FaStackpath,
        path: "/inventory-officer/stocks",
      },
      {
        name: "Purchase",
        icon: FaProductHunt,
        path: "/inventory-officer/purchase",
      },
      {
        name: "Material Request",
        icon: FaProductHunt,
        path: "/inventory-officer/material-request",
      },
    ],
  },
...
const SidebarWithHeader = () => {
  ...
  const renderComponent = () => {
    switch (currentComponent) {
      ...
      case "/SOvehicle":
        return <Vehicle />;
      case "/inventory-officer/items":
        return <Items />;
      case "/inventory-officer/category":
        return <Category />;
      case "/inventory-officer/warehouse":
        return <Warehouse />;
      case "/inventory-officer/stocks":
        return <Stocks />;
      case "/inventory-officer/purchase":
        return <Purchase />;
      case "/inventory-officer/material-request":

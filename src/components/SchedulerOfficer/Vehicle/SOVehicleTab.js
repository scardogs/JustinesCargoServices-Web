...
const TruckList = dynamic(() => import("../Vehicle/SOvehicleList"), {
  ssr: false,
});
const LtoRenewal = dynamic(() => import("../Vehicle/SOltoRenewal"), {
  ssr: false,
});
const LtfrbRenewal = dynamic(() => import("../Vehicle/SOltfrbRenewal"), {
  ssr: false,
});
const InsuranceRenewal = dynamic(
  () => import("../Vehicle/SOinsuranceRenewal"),
  {
    ssr: false,
  }
);
const VehicleLogs = dynamic(() => import("../Vehicle/SOvehicleLogs"), {
  ssr: false,
});
